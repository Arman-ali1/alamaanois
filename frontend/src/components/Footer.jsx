            ...
            <div class="-mx-4 flex flex-wrap justify-between">
              <div class="px-4 my-4 w-full xl:w-1/5">
                <a href="/" className="block mb-10">
                  <div className="flex items-center">
                    ...
                    <img
                      src={logo}
                      alt="logo"
                      className="h-8 w-auto footerLogo"
                    />

                    {/* Al Amaan OIS Text */}
                    <h2 className="inline-block text-2xl ml-4 text-white">
                      Al Amaan OIS
                    </h2>
                  </div>
                </a>
                ...
                <p class="text-justify">
                  ...
                  online and in doing so it provides students the means of
                  learning Islamic Education at comfort of their home.
                </p>
              </div>
